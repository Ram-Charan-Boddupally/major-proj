...
classesFile = "../lisensePlateDetectionConfigs/classes.names"

# Give the configuration and weight files for the model and load the network using them.
modelConfiguration = "../lisensePlateDetectionConfigs/darknet-yolov3.cfg"
modelWeights = "../lisensePlateDetectionConfigs/lapi.weights"
